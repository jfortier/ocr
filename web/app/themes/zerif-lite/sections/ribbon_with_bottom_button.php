  ...
  if( !empty($zerif_bottomribbon_text) ):
    ...
    echo '<section class="separator-one" id="ribbon_bottom">';
      ...
      echo '<div class="color-overlay">';
        ...
        echo '<h1 class="container text" data-scrollreveal="enter left after 0s over 1s">';
          echo '<a href="'.$zerif_bottomribbon_buttonlink.'" class="btn btn-primary custom-button green-btn">';
