...
function zerif_setup() {
    ...
    register_nav_menus(array(
        'primary' => __('Page Menu', 'zerif-lite'),
        'header_menu' => __('Header Menu', 'zerif-lite'),
    ));
...
function zerif_scripts() {
  ...
  wp_enqueue_style('zerif_font', zerif_slug_fonts_url(), array(), null );
    ...
    wp_enqueue_style( 'font_orbitron', '//fonts.googleapis.com/css?family=Orbitron:400,500,700,900');
    ...
    wp_enqueue_style('ocr_style', get_template_directory_uri() . '/css/ocr.css', array(), 'v1');
